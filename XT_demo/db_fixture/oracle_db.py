...
usename_PZ = cf.get("DB_oracle_PZ", "user")
password_PZ = cf.get("DB_oracle_PZ", "password")
ip_port_servername_PZ = cf.get("DB_oracle_PZ", "ip_port_servername")

usename_TJ = cf.get("DB_oracle_TJ", "user")
password_TJ = cf.get("DB_oracle_TJ", "password")
ip_port_servername_TJ = cf.get("DB_oracle_TJ", "ip_port_servername")
...
class BD_oracle_PZ(object):
    """属性链接数据库"""
    def __init__(self):
        global usename_PZ
        global password_PZ
        global ip_port_servername_PZ
        self.connection = cx_Oracle.connect(usename_PZ, password_PZ, ip_port_servername_PZ)
        # logging.debug('This is debug message connection : %s' % self.connection)
        self.cursor = self.connection.cursor()
        # logging.debug('This is debug message cursor : %s' % self.cursor)
    def close(self):
...
class BD_oracle_TJ(object):
    """属性链接数据库"""
    def __init__(self):
        global usename_TJ
        global password_TJ
        global ip_port_servername_TJ
        self.connection = cx_Oracle.connect(usename_TJ, password_TJ, ip_port_servername_TJ)
        # logging.debug('This is debug message connection : %s' % self.connection)
        self.cursor = self.connection.cursor()
        # logging.debug('This is debug message cursor : %s' % self.cursor)
    def close(self):
